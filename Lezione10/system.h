...
const int _n = 110;               //valore costante del numero di città per individuo
const int _np = 100;              //valore costante del numero di individui per popolazione
...
class Individual {
    ...
    void shufflecities(Random&);                        //un altro shuffle ma deterministico
...
class Population {
    ...
    Population(City cities[], int rank);
...
struct needed {             //mini struct per confrontare i costi migliori di tutti i rank
    double cost;
    int rank;
};
